    ...
    const ProviderDropdown = ({ value, onChange, disabled }) => {
        ...
        const renderTriggerContent = () => {
            if (!value || value === 'Select your email source') {
                return <span style={{ color: '#94a3b8' }}>Select your email source</span>;
            }
            return (
                                        ...
                                        <div key={source.id} className="email-source-row" style={{ alignItems: 'flex-start' }}> {/* Align start for success details */}
                                            ...
                                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '5px' }}>
                                                <div className="email-input-container" style={{
                                                    ...
                                                    {source.loading ? (
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', width: '100%' }}>
                                                            <span className="material-icons spin" style={{ fontSize: '18px', color: '#6366f1' }}>sync</span>
                                                            <span style={{ fontSize: '13px', color: '#94a3b8' }}>Connecting to {source.env}...</span>
                                                        </div>
                                                    ) : (
                                                        <>
                                                ...
                                                {source.isAuthenticated && (
                                                    <div style={{ fontSize: '12px', color: '#10b981', display: 'flex', alignItems: 'center', gap: '5px', paddingLeft: '4px' }}>
